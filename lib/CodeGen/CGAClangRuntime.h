//===--- CGAClangRuntime.h - Interface to AClang Runtime -*- C++ -*-===//
//
...
#ifndef CLANG_CODEGEN_AClang_H
#define CLANG_CODEGEN_AClang_H
...
public:
  enum AClangRTLFunction {
    AClangRTL_set_default_device,
    AClangRTL_get_num_devices,
    AClangRTL_get_num_cores,
    AClangRTL_get_default_device,
    AClangRTL_cldevice_init,
    AClangRTL_cldevice_finish,
    AClangRTL_cl_create_read_only,
    AClangRTL_cl_create_write_only,
    AClangRTL_cl_offloading_read_only,
    AClangRTL_cl_offloading_write_only,
    AClangRTL_cl_create_read_write,
    AClangRTL_cl_offloading_read_write,
    AClangRTL_cl_read_buffer,
    AClangRTL_cl_write_buffer,
    AClangRTL_cl_create_program,
    AClangRTL_cl_create_kernel,
    AClangRTL_cl_set_kernel_args,
    AClangRTL_cl_set_kernel_arg,
    AClangRTL_cl_set_kernel_hostArg,
    AClangRTL_cl_execute_kernel,
    AClangRTL_cl_execute_tiled_kernel,
    AClangRTL_cl_release_buffers,
    AClangRTL_cl_release_buffer,
    AClangRTL_cl_get_threads_blocks,
  ...
  llvm::Value *CreateRuntimeFunction(AClangRTLFunction Function);
...
/// \brief Returns an implementation of the AClang RTL for OpenCL targets
CGAClangRuntime *CreateAClangRuntime(CodeGenModule &CGM);
