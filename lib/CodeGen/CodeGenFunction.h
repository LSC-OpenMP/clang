...
public:
  ...
  void pushCleanupAfterFullExpr(CleanupKind Kind, As... A) {
    ...
    LifetimeExtendedCleanupStack.resize(LifetimeExtendedCleanupStack.size() +
...
public:
  ...
  void EmitAggregateCopyCtor(Address DestPtr, Address SrcPtr, QualType DestTy,
                             QualType SrcTy) {
  ...
  void EmitAggregateCopy(Address DestPtr, Address SrcPtr, QualType EltTy,
...
public:
  ...
  llvm::Value *
  EmitLoadOfScalar(Address Addr, bool Volatile, QualType Ty, SourceLocation Loc,
                   AlignmentSource AlignSource = AlignmentSource::Type,
                   llvm::MDNode *TBAAInfo = nullptr,
                   QualType TBAABaseTy = QualType(), uint64_t TBAAOffset = 0,
  ...
  Address
  EmitCXXMemberDataPointerAddress(const Expr *E, Address base,
